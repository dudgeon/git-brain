...
type: research
aliases: [AI scribe, Jordan Wackett paper, blind scribe, verbal anchoring]
...
# AI Scribe Verbal Anchoring Paper

**Project Type:** Perspective piece  
**Target Journal:** Annals of Emergency Medicine (perspective)  
**Status:** In preparation — pivoting for resubmission  
**Co-Authors:** Jordan Wackett (1st author), Steve (2nd author)

## Submission History

| Journal | Submitted | Decision |
|---------|-----------|----------|
| NEJM AI | 2025 | Rejected |
| JAMIA | Jan 31, 2026 | Rejected |

## Current Status
- Rejected from NEJM AI and JAMIA
- Pivoting to submit as a perspective piece to Annals of Emergency Medicine
- Pending resubmission

## Core Concept
"Verbal anchoring" framework for clinician communication with audio-only AI ambient scribes. Three anchor types: temporal, category, and action. Grounded in Clark & Brennan's communication theory.

## Action Items
- [ ] Reformat/revise as Annals of EM perspective piece
- [ ] Resubmit to Annals of Emergency Medicine

## Activity Log

- **2026-02-27:** AI Scribe Verbal Anchoring Paper - blocked. Jordan needs to do additional work before this can progress. No action needed from Steve at this time.
...
- **2026-02-13:** ai-scribe - REJECTED from JAMIA (Journal of the American Medical Informatics Association). Previously rejected from NEJM AI. Will be resubmitted to Annals of Emergency Medicine. Jordan Wackett is lead on resubmission.
...
## Notes
- Jordan leading resubmission effort
